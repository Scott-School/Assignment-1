...
# This is not too complex and doesn't require multiple files.
# TODO: Check the assignment requirements and ensure you have everything correct.
...
# Is run and doesn't update any info if the player and computer tie.
def tie() :
